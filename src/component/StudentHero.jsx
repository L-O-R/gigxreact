...
const HeroSection = () => {
  ...
  // GSAP Animations wrapped in context for better React handling
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      // Subtle entrance animation for the entire section
      ...
      // Split text line animation for heading - wait for fonts
      const animateHeading = () => {
        if (headingRef.current && !splitInstance.current) {
          ...
          // Set initial state explicitly on lines
          ...
          // Fallback: if no lines, animate the whole h1
          if (lines.length === 0) {
            gsap.fromTo(
              headingRef.current,
              { opacity: 0, y: 50 },
      ...
      // Wait for fonts and DOM readiness
      const initSplit = () => {
        if (document.fonts) {
          document.fonts.ready.then(() => {
            // Small delay for ref to be fully rendered
            setTimeout(animateHeading, 100);
          });
        } else {
          setTimeout(animateHeading, 100); // Fallback
        }
      };
      ...
      // Fade in animation for remaining text and potential button
      gsap.fromTo(
        ".card-content",
        { opacity: 0, y: 20 },
        {
      ...
      // Entrance animations for right side boxes on view
    ...
    }, [sectionRef, headingRef, rightSideRef]);
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-black min-h-screen flex items-center px-4 xl:px-6 py-12 mx-2 xl:mx-14 mt-6 rounded-2xl right-side opacity-0 translate-y-[30px]">
      <div className="w-full flex flex-col lg:flex-row items-center gap-2">
        {/* Left Side - Text */}
        <div className="text-white w-full xl:w-[45%] lg:pl-8">
          <h1
            ref={headingRef}
            className="text-5xl sm:text-6xl md:text-[5.5rem] font-normal leading-[110%]">
            Earn between classes.
            <br />
            No cubicles required
          </h1>
          {/* Add button here if needed, with class "card-content" for fade in */}
          {/* <button className="card-content mt-4 px-6 py-3 bg-white text-black rounded-lg">Get Started</button> */}
        </div>
        ...
        <div
          ...
          <div className="hidden lg:grid grid-cols-2 border-white grid-rows-[200px_1fr_1fr] gap-4">
            {/* Pink Card */}
            <div className="hero-card bg-[#B6BAFB] rounded-4xl px-8 pt-8 flex flex-col justify-between row-span-2 opacity-0 translate-y-5">
            ...
            {/* Purple Card */}
            <div className="hero-card bg-[#FFFCEC] rounded-3xl overflow-hidden flex items-start justify-center row-span-3 opacity-0 translate-y-5">
              <img
                src={purpleCard}
            ...
            <div
              ref={countRef}
              className="hero-card bg-[#FF6D39] rounded-3xl px-5 py-6 flex flex-col justify-center row-span-1 opacity-0 translate-y-5">
          ...
          <div className="lg:hidden relative overflow-hidden mt-10">
            <div
              ...
              <div className="w-full shrink-0 px-2 overflow-hidden">
                <div className="hero-card bg-[#B6BAFB] rounded-3xl px-8 pt-8 h-[420px] flex flex-col justify-between opacity-0 translate-y-5">
                  <div className="card-content">
              ...
              <div className="w-full shrink-0 px-2">
                <div className="hero-card bg-[#FF6D39] rounded-3xl p-8 h-[420px] flex flex-col justify-center gap-10 opacity-0 translate-y-5">
                  <div className="mb-4 card-content">
              ...
              {/* Slide 3 - Purple Card */}
              <div className="w-full shrink-0 px-2">
                <div className="hero-card bg-[#FFFCEC] rounded-3xl overflow-hidden h-[420px] flex items-end justify-center opacity-0 translate-y-5">
                  <img
                    src={purpleCard}
                    alt="ID Card"
