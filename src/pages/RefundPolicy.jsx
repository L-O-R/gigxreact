...
const RefundPolicy = () => {
  return (
    <section className="p-4 sm:p-8 lg:p-14 ">
      <h2>Return and Refund Policy</h2>
      <p>Last updated: January 01, 2025</p>
      <p>Thank you for visiting at GigX website or App.</p>
      <p>
        If, for any reason, You are not completely satisfied
        with a purchase We invite You to review our policy
      ...
      <ul>
        <li>
          <p>
            ...
            You on any electronic device, named GigX
          </p>
        </li>
        <li>
          <p>
            ...
            &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this
            Agreement) refers to STUDX Management Private
            Limited, 108, StudX, AMC Avenue, NIBM Annexe,
            Opp. RAHEJA VISTAS PHASE-3, Pune Maharashtra,
            India 411060
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Orders</strong> mean a request by You to
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GigX,
            accessible from{" "}
            <a
              href="https://studx.in/"
      ...
      <p>
        You are entitled to cancel Your Order within 7 days
        without giving any reason for doing so.
      </p>
      <p>
        The deadline for cancelling an Order is 7 days from
        the date on which You received the Goods or on which
        a third party you have appointed, who is not the
        carrier, takes possession of the product delivered.
      </p>
      <p>
        In order to exercise Your right of cancellation, You
        must inform Us of your decision by means of a clear
        statement. You can inform us of your decision by:
      </p>
      <ul>
        <li>
          <p>By email: support@studx.in</p>
        </li>
        <li>
          <p>
      ...
      <p>
        We will reimburse You no later than 14 days from the
        day on which We receive the returned Goods. We will
        use the same means of payment as You used for the
        Order, and You will not incur any fees for such
        reimbursement.
      </p>
      <h2>Conditions for Returns</h2>
      <p>
        In order for the Goods to be eligible for a return,
      ...
      <ul>
        ...
        <li>
          ...
          according to their nature, inseparably mixed with
          other items.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        This exclusion may not apply to You if it is not
        permitted by applicable law.
      </p>
      <h2>Returning Goods</h2>
      <p>
        You are responsible for the cost and risk of
        returning the Goods to Us. You should send the Goods
        at the following address:
      </p>
      <p>
        SN 36(P)Flat no D1101 PRISTINE PACIFIC P AMBEGAON
        BUDRUK
        <br />
      ...
      <p>
        ...
        lost in return shipment. Therefore, We recommend an
        insured and trackable mail service. We are unable to
        issue a refund without actual receipt of the Goods
        or proof of received return delivery.
      </p>
      <h2>Gifts</h2>
      <p>
        If the Goods were marked as a gift when purchased
        and then shipped directly to you, You'll receive a
        gift credit for the value of your return. Once the
        returned product is received, a gift certificate
        will be mailed to You.
      </p>
      <p>
        If the Goods weren't marked as a gift when
        purchased, or the gift giver had the Order shipped
        to themselves to give it to You later, We will send
